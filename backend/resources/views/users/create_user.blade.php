    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"   action="{{ route('users.save-user') }} " enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="avatar" type="file" class="form-control @error('avatar') is-invalid @enderror" name="avatar[]" value="{{ old('avatar') }}"  autocomplete="avatar" autofocus placeholder="Avatar">
                        ...
                        <div class="form-group row">
                            <label for="user_type" class="col-md-2 col-form-label ">{{ __('Category') }}</label>
